...
@ContextConfiguration("/META-INF/messageSource2.xml")
public class ResourceBundleMessageSourceTest2 {
	private Logger logger = LoggerFactory.getLogger(ResourceBundleMessageSourceTest2.class);
